...
process.env.DATASYSTEM_HOST ?= process.env.DATASYSTEM_PORT_9101_TCP_PORT or 'localhost'
...
process.env.HOME_HOST ?= process.env.HOME_PORT_9103_TCP_PORT or 'localhost'
...
process.env.CONTROLLER_HOST ?= process.env.CONTROLLER_PORT_9002_TCP_PORT or 'localhost'
